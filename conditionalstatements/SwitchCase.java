public class SwitchCase {
    public static void main(String[] args) {
        ...
        System.out.println("Time to wake up: " + result);
    }
}
/*
 * #1
 * -- switch statement is a multiway branch statement that allows a variable to
 ...
 * 
 * #2
 * if we have multiple test cases and we want to test for a particular value
 * then we can use switch statement.
 * At the place switch we can also use if-else-if ladder.
 * 
 * e.g
 * suppose user enter a your date of birth and we want to check from multiple
 * year then
 * in this case we can use switch case.
 * 
 * #3
 * what dataType we can use in switch statement?
 * -- the switch statement can have a number of possible execution paths. A
 ...
 * the String class, and a few special classes that wrap certain primitive
 ...
 * are executed in sequence, regardless of the expression of subsequent case
 * labels,
...
// New ways to write switch statements in one line
/*
 * public class SwitchSatements {
 * public static void main(String[] args) {
 * String weekDay = "Monday";
 * switch (weekDay) {
 * case "Sunday", "Saturday" -> System.out.println("Weekend: "+ weekDay);
 * case "Monday" -> System.out.println("Weekday: "+ weekDay);
 * default -> System.out.println("Weekday: "+ weekDay);
 * }
 * }
 * }
 */
