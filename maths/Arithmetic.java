public class Arithmetic {
    ...
    public static void main(String[] args) {
        ...
        int num1 = 7;
        int num2 = 5;
        int addingResult = num1 + num2;
        System.out.println(addingResult);

        int subtractingResult = num1 - num2;
        System.out.println(subtractingResult);

        int multiplyingResult = num1 * num2;
        System.out.println(multiplyingResult);

        int dividingResult = num1 / num2;
 ...
 * b) += is used to assign a value to a variable by adding it to the existing
 * value
 * c) -= is used to assign a value to a variable by subtracting it from the
 * existing value
 * 
 ...
 * copy value is 6;
 * 
 * basicaly pre operation returns a value whereas post does not return a value
 * 
 */